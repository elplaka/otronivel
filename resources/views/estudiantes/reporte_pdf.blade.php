            ...
            <table class="table overflow-scroll table-striped table-bordered table-sm" >
                <thead class="thead-light">
                    <tr style="color:#424242;LINE-HEIGHT:0.25cm">
                        ...
                        <th style="vertical-align:middle;">Turno Escuela</th>
                ...
                <tbody>
                    @foreach ($estudiantes_reporte as $estudiante)
                        <tr>
                            ...
                            <td>{{ $estudiante->nombre . ' ' . $estudiante->primer_apellido . ' ' . $estudiante->segundo_apellido }}</td>
                            <td>{{ $estudiante->escuela->escuela_abreviatura }}</td>
                            <td>{{ $estudiante->carrera }}</td>
                            <td>{{ $estudiante->ciudad->ciudad }}</td>
                            <td>{{ $estudiante->turno->turno }}</td>
