...
<div class="row">
    <div class="card mx-auto">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('boletos.remesas-crea') }}">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="descripcion_apoyos" type="text" class="form-control @error('descripcion_apoyos') is-invalid @enderror" name="descripcion_apoyos" value="{{ old('descripcion') }}" required autocomplete="descripcion_apoyos" autofocus>
